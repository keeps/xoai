...
public class InMemoryItemRepository implements ItemRepository {
  ...
  public ListItemIdentifiersResult getItemIdentifiers(List<ScopedFilter> filters, int offset, int length,
    String scrollId) throws OAIException {
    return new ListItemIdentifiersResult(offset + length < list.size(),
      new ArrayList<ItemIdentifier>(list.subList(offset, min(offset + length, list.size()))));
  }
  ...
  @Override
  public ListItemIdentifiersResult getItemIdentifiers(List<ScopedFilter> filters, int offset, int length,
    String setSpec, String scrollId) throws OAIException {
    // TODO Auto-generated method stub
    return new ListItemIdentifiersResult(false, new ArrayList<ItemIdentifier>());
  }
  ...
  @Override
  public ListItemIdentifiersResult getItemIdentifiers(List<ScopedFilter> filters, int offset, int length,
    String setSpec, Date from, String scrollId) throws OAIException {
    // TODO Auto-generated method stub
    return new ListItemIdentifiersResult(false, new ArrayList<ItemIdentifier>());
  }
  ...
  @Override
  public ListItemIdentifiersResult getItemIdentifiersUntil(List<ScopedFilter> filters, int offset, int length,
    String setSpec, Date until, String scrollId) throws OAIException {
    // TODO Auto-generated method stub
    return new ListItemIdentifiersResult(false, new ArrayList<ItemIdentifier>());
  }
  ...
  @Override
  public ListItemIdentifiersResult getItemIdentifiers(List<ScopedFilter> filters, int offset, int length,
    String setSpec, Date from, Date until, String scrollId) throws OAIException {
    // TODO Auto-generated method stub
    return new ListItemIdentifiersResult(false, new ArrayList<ItemIdentifier>());
  }

  @Override
  public ListItemsResults getItems(List<ScopedFilter> filters, int offset, int length, String scrollId)
    throws OAIException {
    return new ListItemsResults(offset + length < list.size(),
      new ArrayList<Item>(list.subList(offset, min(offset + length, list.size()))));
  }

  @Override
  public ListItemsResults getItems(List<ScopedFilter> filters, int offset, int length, Date from, String scrollId)
    throws OAIException {
    // TODO Auto-generated method stub
    return null;
  }
  ...
  @Override
  public ListItemsResults getItemsUntil(List<ScopedFilter> filters, int offset, int length, Date until, String scrollId)
    throws OAIException {
    // TODO Auto-generated method stub
    return null;
  }
  ...
  @Override
  public ListItemsResults getItems(List<ScopedFilter> filters, int offset, int length, String setSpec, String scrollId)
    throws OAIException {
    // TODO Auto-generated method stub
    return null;
  }
